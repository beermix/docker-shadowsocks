...
RUN apk upgrade --update \
  ...
  && cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=/usr -DCMAKE_VERBOSE_MAKEFILE=ON -DUSE_SHARED_MBEDTLS_LIBRARY=ON -DENABLE_PROGRAMS=0 -DENABLE_TESTING=0 -Wno-dev \
  && make install \
  && cd /tmp \
